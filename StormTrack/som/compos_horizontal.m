	...
	%Composdata='w_NDJFM_lev1000-10_lat0-90_lon20-130_year1979-2010_filter-deseasonal3-highpassNwgt31-0.1'
     ...
     cnintC=0.2%(0.2 air)%(10-height)%(2uwind_pri)%(0.002omega)%(2-vwnd);
     cnintS=2;
 	color_plot=load('hotcold_18lev.rgb')%nrl_sirkes_nowhite%('sunshine_diff_12lev.rgb');%'MPL_PuOr.rgb';load('BlWhRe.rgb');%'MPL_PuOr.rgb'
